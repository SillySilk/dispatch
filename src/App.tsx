...
import './api' // Initialize real API
      ...
      {import.meta.env.VITE_DEMO_MODE === 'true' && (
        <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-center py-2 px-4 text-sm font-medium shadow-lg">
          <div className="flex items-center justify-center gap-2">
            ...
            <span>DEMO VERSION — Data persists in database but this is a demonstration instance.</span>
          </div>
        </div>
      )}

      <Router>
        <div className={`flex h-screen overflow-hidden ${import.meta.env.VITE_DEMO_MODE === 'true' ? 'pt-10' : ''}`}>
          <AppSidebar />
